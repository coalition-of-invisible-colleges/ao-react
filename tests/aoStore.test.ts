...
// import { makeDOMDriver, VNode, div, button } from '@cycle/dom'
...
//     const domSink = xs.of(button('.my-button','Click me'))
//     const domDriver = makeDOMDriver('#app')
//     const domSource = domDriver(domSink)
//     domSource.select('.my-button').add
