...
const AoCalendar: FunctionComponent = observer(() => {
  ...
  if (
    ...
    renderedCalendarList = (
      <div className={'results'}>
        ...
        <AoStack cards={tomorrow} cardStyle={'priority'} alwaysShowAll={true} />
        {thisWeek.length >= 1 ? <h2>This Week</h2> : ''}
        <AoStack cards={thisWeek} cardStyle={'priority'} alwaysShowAll={true} />
